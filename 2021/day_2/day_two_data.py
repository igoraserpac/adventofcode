...
def mkdict(chaves, valores):
    dicionario = {}
    for n in range(len(chaves)):
        novo_dado = {chaves[n]: [valores[n]]}
        if chaves[n] in dicionario:
            dicionario[chaves[n]].append(valores[n])
        else:
            dicionario.update(novo_dado)
    return dicionario


dicionario = mkdict(chaves=condicoes, valores=senhas)
